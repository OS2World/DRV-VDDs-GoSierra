...
/*         if ((rc = (*CODE_mmioIniFileHandlerFunc) ((PMMIO_MMIOINSTALL)CustomPtr, MMIO_INSTALLPROC|MMIO_MATCHFOURCC|MMIO_MATCHDLL|MMIO_MATCHPROCEDURENAME|MMIO_EXTENDED_STRUCT))!=0) { */
