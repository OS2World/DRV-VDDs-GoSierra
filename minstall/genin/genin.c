...
// і ЫЫЫЫЯЯЯЫЫЫЫ ЫЫЫЫЫ ЫЫЫЯ   ЯЫЫЫ і                GENIN/Stub           є
...
ULONG APIENTRY InitGenin (ULONG OwnerHandle, PSZ SourcePath, PSZ DestDrive, PSZ InputParms, ULONG ObjectWindowHandle, PSZ ResponseFileStr) {
   // Like I told you, it's a stub. It doesn't do anything at all
   return 0;
 }

VOID APIENTRY GeninReplacementIdentifier (void) {
   return;
 }
